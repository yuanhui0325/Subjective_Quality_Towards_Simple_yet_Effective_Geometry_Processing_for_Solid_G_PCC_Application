...
void
schro_arith_get_encode_state(const SchroArith *arith, SchroArithEncState *state)
{
  _schro_arith_get_encode_state(arith, state);
}

void
schro_arith_set_encode_state(SchroArith *arith, const SchroArithEncState *state)
{
  _schro_arith_set_encode_state(arith, state);
}
